...
transactions = [
    # id, amount, category, company, card, note, creator, time
    (1, -12, 1, 3, 4, "Test note -12 Food", None, "2020 3 25 18 00 00"),
    (2, -1099, 2, 3, 4, "Test index vr", None, "2020 3 24 19 00 00"),
    (3, 12, 1, 3, 4, "Test 12 Stock", None, "2020 3 23 19 00 00"),
    (4, -21, 1, 3, 4, "Test", None, "2020 3 23 18 00 00"),
    (5, -5, 2, 3, 4, "Food", None, "2020 3 23 17 00 00"),
    (6, -4, 1, 3, 4, "Amount is -4", None, "2020 3 21 12 00 00"),
    (7, 7000, 2, 3, 4, "Test income", None, "2020 3 5 18 00 00"),
    (8, -12, 1, 3, 4, "-12", None, "2020 3 2 18 00 00"),
]
...
def create_bills():
    ...
    for bill in transactions:
        time = datetime(*list(map(int, bill[7].split())), tzinfo=pytz.utc)
